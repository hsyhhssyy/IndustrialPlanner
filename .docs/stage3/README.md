...
4. 公共蓝图索引与增量同步
   - `npm run gen:blueprint-index` 构建期索引
   - 蓝图模式按 `id+blueprintVersion` 增量同步系统蓝图

5. 交互体验增强
   - Shift 连续放置
   - 物品选择器最近项分组
   - 蓝图复制最低门槛统一为“至少 1 个建筑”
   - 供电桩放置范围预览与需电建筑高亮
...
11. `10-planner-right-pane-flow-by-device-tech-proposal.md`
12. `11-public-blueprints-index-and-library-draft.md`
13. `12-blueprint-id-specification.md`
14. `13-stage3-freeze-decision-2026-03-05.md`
...
- 自动布线需求在 Stage3 结项时废弃，不迁移到 Stage4。
- 电力 10 分钟/1 小时窗口需求在 Stage3 结项时废弃。
- 设备详情中的功率字段展示迁移至 Stage4 实现。

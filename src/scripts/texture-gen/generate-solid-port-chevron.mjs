...
const TEXTURES = [
  ...
  // Mobile 版本
  { fileName: 'solid-port-chevron-input-mobile.png',  polygons: SOLID_DOWN_MOBILE_POLYGONS },
  { fileName: 'solid-port-chevron-output-mobile.png', polygons: SOLID_UP_MOBILE_POLYGONS },
];

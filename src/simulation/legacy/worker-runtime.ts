...
import { createTickDebugData, createTickSnapshot } from "./create-tick-snapshot";
import {
  canAdjustDynamicTickRateAtTick,
  resolveDynamicTickRateSwitchIntervalTicks,
  resolveLegalDynamicTickRates,
} from "./phase-gating";
import { advanceDevices } from "./stage-1-advance-devices";
import { buildSolveGraph } from "./stage-2-build-solve-graph";
import { solveTransferGraph, type SolveTransferGraphPerf } from "./stage-3-layered-reverse-solve";
import { rotateRoutingCursors } from "./stage-4-rotate-routing-cursors";
import { settleRecipes } from "./stage-5-settle-recipes";
import { applyBlockageAutoClearance } from "./blockage-auto-clearance";
import {
...
import { computeActiveGasDiffusions } from "./gas-diffusion";
import { computeActiveConsumptionDeviceIds } from "./consumption-channel";
import { applyWaterPurifierManualOutput } from "./water-purifier-node";
import { applySingleBaseRegionalResourceSupply } from "./regional-resource-supply";
import { RegionWarehouseGate, resolveRegionalEpochGateTick } from "./regional-warehouse-gate";
import {

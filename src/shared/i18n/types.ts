...
export type UiKey =
  ...
  | "webDavInitialSync.syncing"
  | "webDavInitialSync.canvasSyncing"
  | "webDavInitialSync.canvasProgress"
  | "webDavInitialSync.failed"
  | "webDavInitialSync.retry"
  | "webDavInitialSync.disable"
  | "webDavStatus.open"
  | "webDavStatus.title"
  | "webDavStatus.overview"
  | "webDavStatus.syncEnabled"
  | "webDavStatus.enabled"
  | "webDavStatus.disabled"
  | "webDavStatus.currentRunReason"
  | "webDavStatus.initialStage"
  | "webDavStatus.pendingLocalChanges"
  | "webDavStatus.lastUpload"
  | "webDavStatus.lastDownload"
  | "webDavStatus.network"
  | "webDavStatus.maxConcurrentRequests"
  | "webDavStatus.activeRequests"
  | "webDavStatus.queuedRequests"
  | "webDavStatus.tasks"
  | "webDavStatus.taskProgress"
  | "webDavStatus.taskLastStarted"
  | "webDavStatus.taskLastFinished"
  ...
  | "webDavStatus.stage.canvas"
  | "webDavStatus.stage.blueprints"
  | "webDavStatus.stage.modules"
  | "webDavStatus.stage.toolbox"
  | "webDavStatus.stage.ready"
  | "webDavStatus.task.canvas"
  | "webDavStatus.task.blueprints"
  | "webDavStatus.task.modules"
  | "webDavStatus.task.toolbox"
  | "webDavStatus.task.background-documents"
  | "webDavStatus.task.directory-maintenance"
  | "webDavStatus.task.interval-check"
  | "webDavStatus.task.device-registration"
  | "webDavStatus.task.remote-devices"
  | "webDavStatus.taskPhase.idle"
  | "webDavStatus.taskPhase.queued"
  | "webDavStatus.taskPhase.running"
  | "webDavStatus.taskPhase.success"
  | "webDavStatus.taskPhase.error"
  | "webDavConflict.discovering"
  | "webDavConflict.applying"
  | "webDavConflict.summary"
  | "webDavConflict.kind.upload"
  | "webDavConflict.kind.download"
  | "webDavConflict.kind.conflict"
  | "webDavConflict.remoteUpdatedAt"
  | "webDavConflict.unknownTime"
  | "webDavConflict.apply"
  | "webDavConflict.batchUseLocal"
  | "webDavConflict.batchUseRemote"
  | "webDavConflict.stopSync"
  | "webDavConflict.itemLabel"
  | "webDavConflict.nameUnavailable"
  | "webDavConflict.currentPlan"
  | "webDavConflict.type.base"
  | "webDavConflict.type.blueprint"
  | "webDavConflict.type.blueprintFolder"
  | "webDavConflict.type.module"
  | "webDavConflict.type.moduleFolder"
  | "webDavConflict.type.moduleCanvas"
  | "webDavConflict.type.moduleCanvasFolder"
  | "webDavConflict.type.productionPlanning"
  | "webDavConflict.type.syncData"
  ...
  | "webDavConfig.deleteAllDataFinalConfirm"
  | "webDavConfig.deleteAllDataDeleting"
  ...
  | "settingsField.experimental-webdav-conflict-title"

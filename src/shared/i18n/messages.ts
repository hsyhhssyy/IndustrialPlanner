...
const MESSAGES: Record<AppLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "productionPlanning.mineralInfinite": "矿物无限",
    "productionPlanning.fromLine": "产线",
    "productionPlanning.infinite": "无限",
  ...
  "en-US": {
    ...
    "productionPlanning.mineralInfinite": "Infinite Minerals",
    "productionPlanning.fromLine": "Line",

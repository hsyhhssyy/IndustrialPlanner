...
const MESSAGES: Record<AppLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settingsField.arknightsAllowEmptyLogisticsEndpointsDescription": "开启后，布设传送带和管道时可以从空地起笔；终点始终允许停在空地。",
  ...
  "en-US": {
    ...
    "settingsField.arknightsAllowEmptyLogisticsEndpointsDescription": "Allow conveyors and pipes to start from an empty cell. Empty-cell targets are always allowed.",

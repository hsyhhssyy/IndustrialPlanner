...
const MESSAGES: Record<AppLocale, Record<string, string>> = {
  "zh-CN": {
    ...
    "settingsField.showFpsDescription": "开启后在画布右上角显示实时 FPS/TPS 指示器。",
  ...
  "en-US": {
    ...
    "settingsField.showFpsDescription": "Show a real-time FPS/TPS indicator at the top-right corner of the canvas when enabled.",

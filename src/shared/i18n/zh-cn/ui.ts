const UI: Record<string, string> = {
    ...
    "settingsField.experimental-webdav-statusDescription": "显示最近一次同步、连接状态和已登记的远端设备。",
    ...
    "settingsField.experimental-webdav-conflict-message": "设备「{remoteDeviceLabel}」的版本与你的版本存在冲突。",
    "settingsField.experimental-webdav-conflict-use-local": "使用我的",
    "settingsField.experimental-webdav-conflict-use-remote": "使用「{remoteDeviceLabel}」的",
    "settingsField.experimental-webdav-conflict-pause": "暂停同步",

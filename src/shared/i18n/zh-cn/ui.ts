const UI: Record<string, string> = {
    ...
    "settingsField.experimental-webdav-sync-enabled": "启用 WebDAV 同步",
    "settingsField.experimental-webdav-sync-enabledDescription": "通过 WebDAV 在你的设备之间同步基地、蓝图、模块配平与生产规划数据。",
    "settingsField.experimental-webdav-url": "WebDAV 地址",
    "settingsField.experimental-webdav-urlDescription": "填写 WebDAV 服务的父级目录地址，系统会自动在其中创建 industrial-planner 目录。",
    "settingsField.experimental-webdav-username": "WebDAV 用户名",
    "settingsField.experimental-webdav-usernameDescription": "用于连接 WebDAV 服务的用户名。",
    "settingsField.experimental-webdav-password": "WebDAV 密码",
    "settingsField.experimental-webdav-passwordDescription": "用于连接 WebDAV 服务的密码或应用专用密码。",
    "settingsField.experimental-webdav-max-concurrent-requests": "WebDAV 最大并发数",
    "settingsField.experimental-webdav-max-concurrent-requestsDescription": "限制同时执行的 WebDAV 网络请求数量。较高数值同步更快，但会增加服务器负载。",

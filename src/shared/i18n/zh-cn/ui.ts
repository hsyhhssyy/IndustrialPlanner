const UI: Record<string, string> = {
    ...
    "webDavSave.failed": "WebDAV 保存失败",
    "webDavSave.saving": "正在保存到 WebDAV",
    "webDavSave.syncFailed": "WebDAV 同步失败",
    "webDavInitialSync.syncing": "正在同步数据",
    "webDavInitialSync.canvasSyncing": "正在同步当前画布",
    "webDavInitialSync.canvasProgress": "当前画布同步进度",
    "webDavInitialSync.failed": "同步数据失败",
    "webDavInitialSync.retry": "重试",
    "webDavInitialSync.disable": "关闭 WebDAV",
    "webDavStatus.open": "修改WebDAV设置",
    "webDavStatus.title": "WebDAV 同步状态",
    "webDavStatus.overview": "同步概览",
    "webDavStatus.syncEnabled": "WebDAV 总开关",
    "webDavStatus.enabled": "已开启",
    "webDavStatus.disabled": "未开启",
    "webDavStatus.currentRunReason": "当前触发原因",
    "webDavStatus.initialStage": "初始同步阶段",
    "webDavStatus.pendingLocalChanges": "待保存本地变更",
    "webDavStatus.lastUpload": "上次上传",
    "webDavStatus.lastDownload": "上次下载",
    "webDavStatus.network": "网络请求",
    "webDavStatus.maxConcurrentRequests": "最大并发数",
    "webDavStatus.activeRequests": "正在执行",
    "webDavStatus.queuedRequests": "等待执行",
    "webDavStatus.tasks": "同步任务",
    "webDavStatus.taskProgress": "进度：{completed}/{total}",
    "webDavStatus.taskLastStarted": "开始：{time}",
    "webDavStatus.taskLastFinished": "结束：{time}",
    "webDavStatus.lastError": "最近错误",
    "webDavStatus.runReason.startup": "网站启动",
    "webDavStatus.runReason.foreground": "回到前台",
    "webDavStatus.runReason.interval": "定时检查",
    ...
    "webDavStatus.stage.toolbox": "工具箱",
    "webDavStatus.stage.ready": "已完成",
    "webDavStatus.task.canvas": "当前画布",
    "webDavStatus.task.blueprints": "蓝图与文件夹",
    "webDavStatus.task.modules": "模块配平",
    "webDavStatus.task.toolbox": "工具箱与生产规划",
    "webDavStatus.task.background-documents": "其他基地文档",
    "webDavStatus.task.directory-maintenance": "远端目录维护",
    "webDavStatus.task.interval-check": "小检查",
    "webDavStatus.task.device-registration": "当前设备登记",
    "webDavStatus.task.remote-devices": "远端设备列表",
    "webDavStatus.taskPhase.idle": "未执行",
    "webDavStatus.taskPhase.queued": "等待中",
    "webDavStatus.taskPhase.running": "执行中",
    "webDavStatus.taskPhase.success": "已完成",
    "webDavStatus.taskPhase.error": "失败",
    "webDavConflict.discovering": "检测到冲突，正在确定范围",
    "webDavConflict.applying": "正在应用冲突处理结果",
    "webDavConflict.summary": "共检测到 {count} 项同步内容。请为每一项选择保留的版本。",
    "webDavConflict.kind.upload": "上传（本地新改动）",
    "webDavConflict.kind.download": "下载（远端新改动）",
    "webDavConflict.kind.conflict": "冲突（双方都有改动）",
    "webDavConflict.remoteUpdatedAt": "远端上传时间：{time}",
    "webDavConflict.unknownTime": "未知",
    "webDavConflict.apply": "应用全部选择",
    "webDavConflict.batchUseLocal": "全部使用我的",
    "webDavConflict.batchUseRemote": "全部使用远端",
    "webDavConflict.stopSync": "保留本地与远端数据，并关闭同步",
    "webDavConflict.itemLabel": "{type} - {name}",
    "webDavConflict.nameUnavailable": "名称不可用",
    "webDavConflict.currentPlan": "当前规划",
    "webDavConflict.type.base": "基地",
    "webDavConflict.type.blueprint": "蓝图",
    "webDavConflict.type.blueprintFolder": "蓝图文件夹",
    "webDavConflict.type.module": "模块",
    "webDavConflict.type.moduleFolder": "模块文件夹",
    "webDavConflict.type.moduleCanvas": "模块画布",
    "webDavConflict.type.moduleCanvasFolder": "模块画布文件夹",
    "webDavConflict.type.productionPlanning": "产线规划",
    "webDavConflict.type.syncData": "同步数据",
    ...
    "webDavConfig.deleteAllDataFinalConfirm": "确认删除",
    "webDavConfig.deleteAllDataDeleting": "正在删除服务器端所有数据，请稍候…",
    ...
    "settingsField.experimental-webdav-status-idle": "空闲",
    "settingsField.experimental-webdav-status-uploading": "上传中",
    "settingsField.experimental-webdav-status-downloading": "下载中",
    "settingsField.experimental-webdav-status-error": "错误",
    ...
    "settingsField.experimental-webdav-conflict-title": "同步冲突",
    "settingsField.experimental-webdav-conflict-message": "远端版本与你的本地版本存在冲突。",
    "settingsField.experimental-webdav-conflict-use-local": "使用我的",
    "settingsField.experimental-webdav-conflict-use-remote": "使用远端",
    "settingsField.experimental-webdav-conflict-pause": "暂不处理",

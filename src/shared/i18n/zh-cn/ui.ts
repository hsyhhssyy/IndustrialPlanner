const UI: Record<string, string> = {
    ...
    "webDavStatus.task.big-check": "大检查",
    ...
    "webDavConflict.summary": "共检测到 {count} 项冲突。请为每一项选择处理方式。",
    ...
    "cloudflareStatus.bigCountdown": "下次大检查",
    ...
    "settingsField.experimental-webdav-conflict-title": "WebDAV 同步冲突",

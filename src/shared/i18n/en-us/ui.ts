const UI: Record<string, string> = {
    ...
    "settingsField.experimental-webdav-statusDescription": "Shows the latest sync timestamps, connection state, and registered remote devices.",
    ...
    "settingsField.experimental-webdav-conflict-message": "The version from device \"{remoteDeviceLabel}\" conflicts with your local version.",
    "settingsField.experimental-webdav-conflict-use-local": "Use Mine",
    "settingsField.experimental-webdav-conflict-use-remote": "Use {remoteDeviceLabel}'s",
    "settingsField.experimental-webdav-conflict-pause": "Pause Sync",

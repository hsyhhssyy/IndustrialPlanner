const UI: Record<string, string> = {
    ...
    "webDavStatus.open": "View Sync Status",
    ...
    "settingsField.experimental-webdav-sync-enabled": "Enable WebDAV Sync",
    "settingsField.experimental-webdav-sync-enabledDescription": "Sync base documents, blueprints, module balancing data, and production planning data across your devices through WebDAV.",
    "settingsField.experimental-webdav-url": "WebDAV URL",
    "settingsField.experimental-webdav-urlDescription": "Enter the parent WebDAV directory. The app will create an industrial-planner directory inside it.",
    "settingsField.experimental-webdav-username": "WebDAV Username",
    "settingsField.experimental-webdav-usernameDescription": "The username used to connect to the WebDAV service.",
    "settingsField.experimental-webdav-password": "WebDAV Password",
    "settingsField.experimental-webdav-passwordDescription": "The password or app-specific password used to connect to the WebDAV service.",
    "settingsField.experimental-webdav-max-concurrent-requests": "Maximum WebDAV Concurrency",
    "settingsField.experimental-webdav-max-concurrent-requestsDescription": "Limits concurrent WebDAV network requests. Higher values can sync faster but increase server load.",

...
export const ENTITY_VARIANT_DEFINITIONS: Readonly<Record<string, EntityVariantDefinition>> = {
  normal: {
    ...
    iconPath: "assets/machine-mode-icons/icon_port_normal.webp",
  },
  gas: {
    variantName: "gas",
    shortNameKey: GAS_SHORT_NAME_KEY,
    longNameKey: GAS_LONG_NAME_KEY,
    iconPath: "assets/machine-mode-icons/icon_port_gas.webp",
  },
  gastrans: {
    variantName: "gastrans",
    shortNameKey: GAS_SHORT_NAME_KEY,
    longNameKey: GAS_LONG_NAME_KEY,
    iconPath: "assets/machine-mode-icons/icon_port_gastrans.webp",
  },
  liquid: {
    variantName: "liquid",
    shortNameKey: LIQUID_SHORT_NAME_KEY,
    longNameKey: LIQUID_LONG_NAME_KEY,
    iconPath: "assets/machine-mode-icons/icon_port_liquid.webp",
  },
  liquidtrans: {
    variantName: "liquidtrans",
    shortNameKey: LIQUID_SHORT_NAME_KEY,
    longNameKey: LIQUID_LONG_NAME_KEY,
    iconPath: "assets/machine-mode-icons/icon_port_liquidtrans.webp",
  },
  solidtrans: {
    variantName: "solidtrans",
    shortNameKey: SOLID_SHORT_NAME_KEY,
    longNameKey: SOLID_LONG_NAME_KEY,
    iconPath: "assets/machine-mode-icons/icon_port_solidtrans.webp",
  },
};

...
export const ENTITY_VARIANT_DEFINITIONS: Readonly<Record<string, EntityVariantDefinition>> = {
  normal: {
    ...
    iconPath: "assets/entity-variant-icons/icon_port_solid.png",
  },
  gas: {
    variantName: "gas",
    shortNameKey: GAS_SHORT_NAME_KEY,
    longNameKey: GAS_LONG_NAME_KEY,
    iconPath: "assets/entity-variant-icons/icon_port_gas.png",
  },
  gastrans: {
  ...
  liquid: {
    ...
    iconPath: "assets/entity-variant-icons/icon_port_liquid.png",
  },
  liquidtrans: {

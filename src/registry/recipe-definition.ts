...
// AI-CORRECTION 2026-07-19: 历史注释中的 item_/item_port_ 设备 ID 保留作来源审计；
// 当前 RecipeDefinition.machineId 必须引用已移除前缀的 EntityDefinition.id。
export const RECIPE_DEFINITIONS: RecipeDefinition[] = [
  ...
  },
  {
    ...
    nameKey: "registry.recipe.furnance_activity_xiranite_nugget_1.name",
    durationSeconds: 2,
  ...
  },
  {
    ...
    nameKey: "registry.recipe.furnance_activity_xiranite_enr_nugget_1.name",
    durationSeconds: 10,
  ...
  },
  {
    ...
    nameKey: "registry.recipe.shaper_activity_xiranite_box_1.name",
    durationSeconds: 2,
  ...
  },
  {
    ...
    nameKey: "registry.recipe.shaper_gas_activity_xiranite_enr_box_1.name",
    durationSeconds: 10,
    inputs: [
  ...
  },
  {
    ...
    nameKey: "registry.recipe.component_activity_copper_poly_cmpt.name",
    durationSeconds: 10,
  ...
  },
  {
    ...
    nameKey: "registry.recipe.tools_proc_activity_xiranite_copper_tool_1.name",
    durationSeconds: 2,
    inputs: [
  ...
  },
  {
    ...
    nameKey: "registry.recipe.tools_proc_activity_xiranite_lung.name",
    durationSeconds: 10,
    inputs: [
  ...
  },
  {
    ...
    nameKey: "registry.recipe.tools_proc_activity_copper_poly_tool_1.name",
    durationSeconds: 10,
    inputs: [
  ...
  },
  {
    ...
    nameKey: "registry.recipe.tools_proc_activity_xiranite_enr_lung.name",
    durationSeconds: 10,
    inputs: [
  ...
  },
  {
    ...
    machineId: "filling_pd_mc_1_liquid",
    recipeType: "immediate-consume",
    tags: ["bottle_filling"],
  },
  {
  ...
  {
    id: "r_gas_collector_inert_basic",
    nameKey: "registry.recipe.r_gas_collector_inert_basic.name",
    durationSeconds: 3,
    inputs: [],
    outputs: [{ itemId: "item_gas_inert", amount: 1 }],
    machineId: "gas_pump_1",
    recipeType: "immediate-consume",
    tags: ["自然资源采集"],
  },
  {
    id: "r_gas_collector_xiranite_basic",
    nameKey: "registry.recipe.r_gas_collector_xiranite_basic.name",
    durationSeconds: 3,
    inputs: [],
  ...
  },
  {
    ...
    nameKey: "registry.recipe.gas_reactor_activity_copper_poly_gas_1.name",
    durationSeconds: 2,
    inputs: [
  ...
  },
  {
    ...
    nameKey: "registry.recipe.liquid_transmuter_2_activity_copper_poly_gas_1.name",
    durationSeconds: 2,
  ...
  },
  {
    ...
    nameKey: "registry.recipe.liquid_transmuter_2_activity_copper_poly_1.name",
    durationSeconds: 2,

...
export const RECIPE_DEFINITIONS: RecipeDefinition[] = [
  ...
  {
    id: "demo_gas_copper_from_copper_nugget_and_xiranite_gas",
    nameKey: "registry.recipe.demo_gas_copper_from_copper_nugget_and_xiranite_gas.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "item_copper_nugget", amount: 1 },
      { itemId: "item_gas_xiranite", amount: 1 },
    ],
    outputs: [{ itemId: "demo_gas_copper", amount: 1 }],
    machineId: "item_port_solid_gas_converter_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_copper_scorched_from_gas_copper_scorched_and_xiranite_gas",
    nameKey: "registry.recipe.demo_copper_scorched_from_gas_copper_scorched_and_xiranite_gas.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_gas_copper_scorched", amount: 1 },
      { itemId: "item_gas_xiranite", amount: 1 },
    ],
    outputs: [{ itemId: "demo_copper_scorched", amount: 1 }],
    machineId: "item_port_solid_gas_converter_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_xiranite_enr_powder_from_gas_xiranite_enr_and_xiranite_gas",
    nameKey: "registry.recipe.demo_xiranite_enr_powder_from_gas_xiranite_enr_and_xiranite_gas.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_gas_xiranite_enr", amount: 1 },
      { itemId: "item_gas_xiranite", amount: 1 },
    ],
    outputs: [{ itemId: "item_xiranite_enr_powder", amount: 1 }],
    machineId: "item_port_solid_gas_converter_1",
  ...
  {
    id: "demo_copper_enr_from_gas_copper_enr_and_xiranite_gas",
    nameKey: "registry.recipe.demo_copper_enr_from_gas_copper_enr_and_xiranite_gas.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_gas_copper_enr", amount: 1 },
      { itemId: "item_gas_xiranite", amount: 1 },
    ],
  ...
  {
    id: "demo_gas_acid_from_acid_and_liquid_xiranite",
    nameKey: "registry.recipe.demo_gas_acid_from_acid_and_liquid_xiranite.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "item_liquid_acid", amount: 1 },
      { itemId: "item_liquid_xiranite", amount: 1 },
    ],
    outputs: [{ itemId: "demo_gas_acid", amount: 1 }],
    machineId: "item_port_liquid_gas_converter_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_gas_copper_scorched_from_gas_copper_enr_and_xiranite_gas_in_acid",
    nameKey: "registry.recipe.demo_gas_copper_scorched_from_gas_copper_enr_and_xiranite_gas_in_acid.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_gas_copper_enr", amount: 1 },
      { itemId: "item_gas_xiranite", amount: 1 },
    ],
    outputs: [{ itemId: "demo_gas_copper_scorched", amount: 1 }],
    machineId: "item_port_gas_reactor_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
    requiredGasDiffusion: "demo_gas_acid",
  },
  {
    id: "demo_copper_ingot_from_copper_nugget_and_inert_gas",
    nameKey: "registry.recipe.demo_copper_ingot_from_copper_nugget_and_inert_gas.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "item_copper_nugget", amount: 1 },
      { itemId: "item_gas_inert", amount: 1 },
    ],
    outputs: [{ itemId: "demo_copper_ingot", amount: 1 }],
    machineId: "item_port_shaper_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_white_copper_tube_from_copper_ingot_and_xiranite",
    nameKey: "registry.recipe.demo_white_copper_tube_from_copper_ingot_and_xiranite.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_copper_ingot", amount: 1 },
      { itemId: "item_xiranite_powder", amount: 1 },
    ],
    outputs: [{ itemId: "demo_white_copper_tube", amount: 1 }],
    machineId: "item_port_tools_asm_mc_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_copper_scorched_cmpt_from_copper_scorched",
    nameKey: "registry.recipe.demo_copper_scorched_cmpt_from_copper_scorched.name",
    durationSeconds: 1,
    inputs: [{ itemId: "demo_copper_scorched", amount: 1 }],
    outputs: [{ itemId: "demo_copper_scorched_cmpt", amount: 1 }],
    machineId: "item_port_cmpt_mc_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_gas_xiranite_enr_from_gas_xiranite",
    nameKey: "registry.recipe.demo_gas_xiranite_enr_from_gas_xiranite.name",
    durationSeconds: 1,
    inputs: [{ itemId: "item_gas_xiranite", amount: 1 }],
    outputs: [{ itemId: "demo_gas_xiranite_enr", amount: 1 }],
    machineId: "item_port_liquid_purifier_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_gas_copper_enr_from_white_copper_tube_and_gas_copper",
    nameKey: "registry.recipe.demo_gas_copper_enr_from_white_copper_tube_and_gas_copper.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_white_copper_tube", amount: 1 },
      { itemId: "demo_gas_copper", amount: 1 },
    ],
    outputs: [{ itemId: "demo_gas_copper_enr", amount: 1 }],
    machineId: "item_port_liquid_purifier_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_equip_script_scorched_from_copper_scorched_cmpt_and_xiranite_enr_powder",
    nameKey: "registry.recipe.demo_equip_script_scorched_from_copper_scorched_cmpt_and_xiranite_enr_powder.name",
    durationSeconds: 1,
    inputs: [
      { itemId: "demo_copper_scorched_cmpt", amount: 1 },
      { itemId: "item_xiranite_enr_powder", amount: 1 },
    ],
    outputs: [{ itemId: "demo_equip_script_scorched", amount: 1 }],
    machineId: "item_port_winder_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
  },
  {
    id: "demo_gas_diffuser_acid_gas_environment",
    nameKey: "registry.recipe.demo_gas_diffuser_acid_gas_environment.name",
    durationSeconds: 1,
    inputs: [{ itemId: "demo_gas_acid", amount: 1 }],
    outputs: [],
    machineId: "item_port_gas_diffuser_1",
    recipeType: "immediate-consume",
    tags: ["demo", "introduced:1.4"],
    gasDiffusionOutput: {
      gasItemId: "demo_gas_acid",
      range: 1,
    },
  },
];

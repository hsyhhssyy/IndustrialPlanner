...
export const ITEM_DEFINITIONS: ItemDefinition[] = [
  ...
  {
    id: "demo_gas_copper",
    nameKey: "registry.item.demo_gas_copper.name",
    iconId: "demo_gas_copper",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_copper_scorched",
    nameKey: "registry.item.demo_copper_scorched.name",
    iconId: "demo_copper_scorched",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_gas_copper_scorched",
    nameKey: "registry.item.demo_gas_copper_scorched.name",
    iconId: "demo_gas_copper_scorched",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_gas_xiranite_enr",
    nameKey: "registry.item.demo_gas_xiranite_enr.name",
    iconId: "demo_gas_xiranite_enr",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_gas_copper_enr",
    nameKey: "registry.item.demo_gas_copper_enr.name",
    iconId: "demo_gas_copper_enr",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_gas_acid",
    nameKey: "registry.item.demo_gas_acid.name",
    iconId: "demo_gas_acid",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_copper_ingot",
    nameKey: "registry.item.demo_copper_ingot.name",
    iconId: "demo_copper_ingot",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_white_copper_tube",
    nameKey: "registry.item.demo_white_copper_tube.name",
    iconId: "demo_white_copper_tube",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_copper_scorched_cmpt",
    nameKey: "registry.item.demo_copper_scorched_cmpt.name",
    iconId: "demo_copper_scorched_cmpt",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
  {
    id: "demo_equip_script_scorched",
    nameKey: "registry.item.demo_equip_script_scorched.name",
    iconId: "demo_equip_script_scorched",
    tags: ["demo", "introduced:1.4"],
    displayOrder: 10000,
  },
];

        ...
        groups: [
          {
            ...
            rows: [
              ...
              { mode: '通用', icon: 'help', action: '右键优先取消当前预览；若无预览则取消当前选择；Esc 关闭当前动作或对话框', keys: ['右键', 'Esc'] },
              ...
              { mode: '通用', icon: 'delete', action: '删除当前选中的建筑', keys: ['Delete / F'] },
          ...
          },
          {
            ...
            rows: [
              ...
              { mode: '放置模式', icon: 'place', action: '旋转当前选中的建筑', keys: ['R'] },
              { mode: '放置模式', icon: 'place', action: '切换传送带物流布设，再按一次退出到默认放置态', keys: ['E'] },
              { mode: '放置模式', icon: 'place', action: '切换管道物流布设，再按一次退出到默认放置态', keys: ['Q'] },
              { mode: '放置模式', icon: 'place', action: '高亮资源与电力 / 仓库存取 / 基础生产 / 合成制造分类，随后可按数字键快速放置', keys: ['X / C / V / B'] },
              { mode: '放置模式', icon: 'place', action: '按当前高亮分类的视觉排序直接选择第 1-9、0 个建筑', keys: ['1-9', '0', '小键盘 1-9/0'] },
              { mode: '放置模式', icon: 'place', action: '放下后保持当前建筑继续放置', keys: ['Shift / Ctrl / Cmd', '左键'] },
              { mode: '放置模式', icon: 'blueprint', action: '把当前选中的建筑保存为蓝图', keys: ['Ctrl/Cmd', 'S'] },
              { mode: '蓝图模式', icon: 'blueprint', action: '旋转当前蓝图预览', keys: ['R'] },
              { mode: '蓝图模式', icon: 'blueprint', action: '复制当前选中建筑为临时蓝图', keys: ['Ctrl/Cmd', 'C'] },
              { mode: '蓝图模式', icon: 'blueprint', action: '恢复上次临时蓝图', keys: ['Ctrl/Cmd', 'V'] },
          ...
          },
          {
            title: '删除',
            rows: [
              { mode: '删除模式', icon: 'delete', action: '删除当前点击到的建筑，或按当前子模式删除整条物流线', keys: ['左键'] },
              { mode: '删除模式', icon: 'delete', action: '框选一片区域后删除其中的建筑', keys: ['左键拖拽'] },
            ],
          },
      ...
      groups: [
        {
          ...
          rows: [
            ...
            { mode: 'General', icon: 'help', action: 'Right click cancels the current preview first; if nothing is armed, it clears the current selection. Esc closes the current action or dialog.', keys: ['Right Click', 'Esc'] },
            ...
            { mode: 'General', icon: 'delete', action: 'Delete the current selected buildings', keys: ['Delete / F'] },
        ...
        },
        {
          ...
          rows: [
            ...
            { mode: 'Place Mode', icon: 'place', action: 'Rotate the current selected buildings', keys: ['R'] },
            { mode: 'Place Mode', icon: 'place', action: 'Toggle conveyor logistics routing; press again to return to the default place state', keys: ['E'] },
            { mode: 'Place Mode', icon: 'place', action: 'Toggle pipe logistics routing; press again to return to the default place state', keys: ['Q'] },
            { mode: 'Place Mode', icon: 'place', action: 'Arm Resources & Power / Storage & IO / Basic Production / Advanced Manufacturing for digit quick-place', keys: ['X / C / V / B'] },
            { mode: 'Place Mode', icon: 'place', action: 'Select the 1-9 or 0 building in the armed category by current visual order', keys: ['1-9', '0', 'Numpad 1-9/0'] },
            { mode: 'Place Mode', icon: 'place', action: 'Keep the current building armed after placing it', keys: ['Shift / Ctrl / Cmd', 'Left Click'] },
            { mode: 'Place Mode', icon: 'blueprint', action: 'Save the current selection as a blueprint', keys: ['Ctrl/Cmd', 'S'] },
            { mode: 'Blueprint Mode', icon: 'blueprint', action: 'Rotate the current blueprint preview', keys: ['R'] },
            { mode: 'Blueprint Mode', icon: 'blueprint', action: 'Copy current selection as a temporary blueprint', keys: ['Ctrl/Cmd', 'C'] },
            { mode: 'Blueprint Mode', icon: 'blueprint', action: 'Restore the last temporary blueprint', keys: ['Ctrl/Cmd', 'V'] },
        ...
        },
        {
          title: 'Delete',
          rows: [
            { mode: 'Delete Mode', icon: 'delete', action: 'Delete the clicked building, or the whole logistics route in the matching sub-mode', keys: ['Left Click'] },
            { mode: 'Delete Mode', icon: 'delete', action: 'Drag a box and delete the buildings inside it', keys: ['Left Drag'] },
          ],
        },
      ] satisfies HotkeyGroup[],
    }

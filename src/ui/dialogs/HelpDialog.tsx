        ...
        groups: [
          ...
          },
          {
            ...
            rows: [
              ...
              { mode: '放置模式', icon: 'place', action: '放下后保持当前建筑继续放置', keys: ['Shift', '左键'] },
      ...
      groups: [
        ...
        },
        {
          ...
          rows: [
            ...
            { mode: 'Place Mode', icon: 'place', action: 'Keep the current building armed after placing it', keys: ['Shift', 'Left Click'] },

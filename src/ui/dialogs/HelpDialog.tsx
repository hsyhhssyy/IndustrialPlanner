        ...
        groups: [
          {
            ...
            rows: [
              ...
              { mode: '通用', icon: 'canvas', action: '框选区域，或在删除模式下框选待删除区域', keys: ['左键拖拽'] },
              { mode: '通用', icon: 'canvas', action: '按住修饰键点选建筑，加入或移出当前多选', keys: ['Ctrl/Cmd/Shift', '左键'] },
              { mode: '通用', icon: 'canvas', action: '拖拽当前选中的建筑', keys: ['左键拖拽', '已选建筑'] },
              ...
              { mode: '通用', icon: 'help', action: '取消当前放置 / 临时蓝图 / 链接预览，或关闭对话框', keys: ['右键', 'Esc'] },
      ...
      groups: [
        {
          ...
          rows: [
            ...
            { mode: 'General', icon: 'canvas', action: 'Box-select an area, or mark a delete area in Delete mode', keys: ['Left Drag'] },
            { mode: 'General', icon: 'canvas', action: 'Add or remove a building from the current multi-selection', keys: ['Ctrl/Cmd/Shift', 'Left Click'] },
            { mode: 'General', icon: 'canvas', action: 'Drag the current selected buildings', keys: ['Left Drag', 'Selected Building'] },
            ...
            { mode: 'General', icon: 'help', action: 'Cancel current placement/temp blueprint/link preview, or close a dialog', keys: ['Right Click', 'Esc'] },

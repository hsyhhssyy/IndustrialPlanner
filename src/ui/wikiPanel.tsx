    ...
    language === 'zh-CN'
      ? [
          ...
          },
          {
            ...
            steps: [
              '左键：选择或放置。',
              '左键拖拽：铺设传送带/管道、框选建筑，或拖动已选中的建筑（取决于当前操作）。',
              'Ctrl/Cmd/Shift + 左键：把建筑加入或移出当前多选。',
              '鼠标滚轮：缩放画布。',
              '鼠标中键拖拽：平移画布。',
              '触控设备双指捏合：缩放画布。',
              '右键：取消当前放置、临时蓝图或链接预览。',
          ...
          },
          {
            ...
            steps: [
              ...
              'Ctrl+V：恢复上次复制的临时蓝图。',
              'Shift / Ctrl / Cmd + 左键：放置后保持当前建筑继续放置。',
              'Delete / F：删除当前选中的建筑。',
              'Ctrl/Cmd+Z、Ctrl+Shift/Cmd+Shift+Z、Ctrl+Y：撤销 / 重做。',
              'Esc：退出当前工具、取消当前操作，或关闭弹窗。',
            ],
          },
          {
            title: '4) 一次完整操作流程',
      ...
      : [
          ...
          },
          {
            ...
            steps: [
              ...
              'Delete / F: delete the current selected buildings.',
              ...
              'Shift / Ctrl / Cmd + Left Click: keep the current building armed after placing it.',
              'Ctrl/Cmd+Z, Ctrl+Shift/Cmd+Shift+Z, Ctrl+Y: undo / redo.',
              'Esc: exit the current tool, cancel the current action, or close dialogs.',
            ],
          },
          {

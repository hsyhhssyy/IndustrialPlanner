// AI-REMOVED 2026-06-21:
// Reason: FPS Meter 从 PixiJS renderer 层迁移到 React DOM canvas-panel 层,
//   改为可折叠面板, 每秒轮询一次数据而非每帧 sync。
// Trigger: 用户要求 "从 render 移动到 canvas, 改成和 gesture debuger 一样的可折叠面板"
// Evidence: canvas-panel.tsx 中新增 CanvasFpsOverlay 组件, render-scene-orchestrator.ts 中已移除引用
// Replacement: src/app/shell/canvas/canvas-panel.tsx (CanvasFpsOverlay)
// Risk: Low

...
// Replacement: src/tests/fixtures/blueprints/simulation/dark-pipe-throughput/index.json
// Risk: Low；断言与被测动作不变。
...
// Human Review: Required
// Original code:
// import { createEntity, getDevice, getLastTick } from "./blueprint-test-helpers";

...
import type { RegionWarehouseDeposit, RegionalWarehouseOutletTable } from "@/simulation/regional/types";
import type { RegionalBasePort } from "@/simulation/legacy/regional-session";
...
} from "@/simulation/dense/dense-simulation-kernel";
import { compileDenseTopologyLayout } from "@/simulation/dense/dense-topology";

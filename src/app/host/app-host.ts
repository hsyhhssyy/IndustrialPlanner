...
export function createAppHost(
  ...
  const internalActions: AppInternalAction = {
    ...
    toggleRightDockBaseExpanded: actionImpl.toggleRightDockBaseExpanded,
    toggleRightDockPowerExpanded: actionImpl.toggleRightDockPowerExpanded,
    toggleRightDockSelectionExpanded: actionImpl.toggleRightDockSelectionExpanded,
    openHelpDialog: actionImpl.openHelpDialog,
    closeHelpDialog: actionImpl.closeHelpDialog,
    toggleHelpDialogMaximized: actionImpl.toggleHelpDialogMaximized,
    setHelpDialogTab: actionImpl.setHelpDialogTab,

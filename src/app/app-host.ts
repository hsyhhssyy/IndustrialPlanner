...
export function createAppHost(
  ...
  const internalActions: AppInternalAction = {
    ...
    showCanvasToolbarForCollection: actionImpl.showCanvasToolbarForCollection,
    moveCanvasToolbar: actionImpl.moveCanvasToolbar,
    alignCanvasToolbar: actionImpl.alignCanvasToolbar,
    setCanvasToolbarSize: actionImpl.setCanvasToolbarSize,

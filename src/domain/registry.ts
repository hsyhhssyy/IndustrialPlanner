...
export const ITEMS: ItemDef[] = [
  ...
  { id: 'chrono_item_copper_ore', displayName: '赤铜矿', type: 'solid', tags: ['矿石', '超时空'] },
  { id: 'chrono_item_refined_copper', displayName: '精铜', type: 'solid', tags: ['超时空'] },
  { id: 'chrono_item_wastewater', displayName: '污水', type: 'liquid', tags: ['超时空', 'liquid_color:#808080'] },
  { id: 'chrono_item_copper_equip_script', displayName: '赤铜装备原件', type: 'solid', tags: ['超时空'] },
  { id: 'chrono_item_xiranite_waste_liquid', displayName: '壤晶废液', type: 'liquid', tags: ['超时空', 'liquid_color:#111111'] },
  { id: 'chrono_item_inert_xiranite_waste_liquid', displayName: '惰性壤晶废液', type: 'liquid', tags: ['超时空', 'liquid_color:#4a2f1f'] },
  { id: 'chrono_item_xiranite_waste_slag', displayName: '壤晶废料', type: 'solid', tags: ['超时空'] },
  { id: 'chrono_item_medium_wuling_battery', displayName: '中容武陵电池', type: 'solid', tags: ['超时空'] },
  ...
  { id: 'item_glass_bottle_filled_water', displayName: '紫晶质瓶（已盛装清水）', type: 'solid' },
  { id: 'item_glass_bottle_filled_liquid_plant_grass_1', displayName: '紫晶质瓶（已盛装锦草溶液）', type: 'solid' },
  { id: 'item_glass_bottle_filled_liquid_plant_grass_2', displayName: '紫晶质瓶（已盛装芽针溶液）', type: 'solid' },
  { id: 'item_glass_bottle_filled_liquid_xiranite', displayName: '紫晶质瓶（已盛装液化息壤）', type: 'solid' },
  { id: 'item_glass_cmpt', displayName: '紫晶零件', type: 'solid' },
  { id: 'item_glass_enr_bottle', displayName: '高晶质瓶', type: 'solid' },
  { id: 'item_glass_enr_bottle_filled_water', displayName: '高晶质瓶（已盛装清水）', type: 'solid' },
  { id: 'item_glass_enr_bottle_filled_liquid_plant_grass_1', displayName: '高晶质瓶（已盛装锦草溶液）', type: 'solid' },
  { id: 'item_glass_enr_bottle_filled_liquid_plant_grass_2', displayName: '高晶质瓶（已盛装芽针溶液）', type: 'solid' },
  { id: 'item_glass_enr_bottle_filled_liquid_xiranite', displayName: '高晶质瓶（已盛装液化息壤）', type: 'solid' },
  { id: 'item_glass_enr_cmpt', displayName: '高晶零件', type: 'solid' },
  { id: 'item_iron_bottle', displayName: '蓝铁瓶', type: 'solid' },
  { id: 'item_iron_bottle_filled_water', displayName: '蓝铁瓶（已盛装清水）', type: 'solid' },
  { id: 'item_iron_bottle_filled_liquid_plant_grass_1', displayName: '蓝铁瓶（已盛装锦草溶液）', type: 'solid' },
  { id: 'item_iron_bottle_filled_liquid_plant_grass_2', displayName: '蓝铁瓶（已盛装芽针溶液）', type: 'solid' },
  { id: 'item_iron_bottle_filled_liquid_xiranite', displayName: '蓝铁瓶（已盛装液化息壤）', type: 'solid' },
  ...
  { id: 'item_iron_enr_bottle_filled_water', displayName: '钢质瓶（已盛装清水）', type: 'solid' },
  { id: 'item_iron_enr_bottle_filled_liquid_plant_grass_1', displayName: '钢质瓶（已盛装锦草溶液）', type: 'solid' },
  { id: 'item_iron_enr_bottle_filled_liquid_plant_grass_2', displayName: '钢质瓶（已盛装芽针溶液）', type: 'solid' },
  { id: 'item_iron_enr_bottle_filled_liquid_xiranite', displayName: '钢质瓶（已盛装液化息壤）', type: 'solid' },
...
export const RECIPES: RecipeDef[] = [
  ...
  },
  {
    ...
    cycleSeconds: 2,
    inputs: [
      { itemId: 'chrono_item_copper_ore', amount: 1 },
      { itemId: 'item_liquid_water', amount: 1 },
    ],
    outputs: [
      { itemId: 'chrono_item_refined_copper', amount: 1 },
      { itemId: 'chrono_item_wastewater', amount: 1 },
    ],
    tags: ['超时空'],
  },
  {
    id: 'r_chrono_wastewater_treatment_void_wastewater_basic',
    machineType: 'item_port_wastewater_treatment_1',
    cycleSeconds: 2,
    inputs: [{ itemId: 'chrono_item_wastewater', amount: 1 }],
    outputs: [],
    tags: ['超时空'],
  },
  {
    ...
    machineType: 'item_port_wastewater_treatment_1',
    cycleSeconds: 2,
    inputs: [{ itemId: 'chrono_item_xiranite_waste_liquid', amount: 1 }],
    outputs: [],
    tags: ['超时空'],
  },
  {
    ...
    machineType: 'item_port_wastewater_treatment_1',
    cycleSeconds: 2,
    inputs: [{ itemId: 'chrono_item_inert_xiranite_waste_liquid', amount: 1 }],
    outputs: [],
    tags: ['超时空'],
  },
  {
    ...
    cycleSeconds: 10,
    inputs: [
      { itemId: 'chrono_item_refined_copper', amount: 10 },
      { itemId: 'item_xiranite_powder', amount: 10 },
    ],
    outputs: [{ itemId: 'chrono_item_copper_equip_script', amount: 1 }],
    tags: ['超时空'],
  },
  {
    ...
    outputs: [
      { itemId: 'chrono_item_xiranite_waste_liquid', amount: 1 },
      { itemId: 'chrono_item_inert_xiranite_waste_liquid', amount: 1 },
    ],
    tags: ['超时空'],
  },
  {
    ...
    cycleSeconds: 2,
    inputs: [
      { itemId: 'chrono_item_xiranite_waste_liquid', amount: 2 },
      { itemId: 'item_iron_powder', amount: 1 },
    ],
    outputs: [
      { itemId: 'chrono_item_inert_xiranite_waste_liquid', amount: 1 },
      { itemId: 'item_liquid_water', amount: 1 },
      { itemId: 'chrono_item_xiranite_waste_slag', amount: 1 },
    ],
    tags: ['超时空'],
  },
  {
    ...
    cycleSeconds: 10,
    inputs: [
      { itemId: 'chrono_item_xiranite_waste_slag', amount: 10 },
      { itemId: 'item_originium_enr_powder', amount: 15 },
    ],
    outputs: [{ itemId: 'chrono_item_medium_wuling_battery', amount: 1 }],
    tags: ['超时空'],
  },
  {
...
const DEVICE_TYPES_BASE: Array<DeviceTypeDef> = [
  ...
  {
    id: 'item_port_wastewater_treatment_1',
    runtimeKind: 'storage',
    requiresPower: true,
    powerDemand: 20,
    size: { width: 3, height: 3 },
    shortName: 'WastewaterTreatment',
    tags: ['武陵', '超时空', 'OuterRingAllowed'],
    ports0: [
      {
        id: 'in_w_1',
        localCellX: 0,
